    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">Issue Product</div>
                        <div class="panel-body">                        
                            <div class="panel">
                                <div class="panel-body">
                                    <form method="post" action="<?php echo site_url('issueproduct/savetempissue'); ?>" class="form-horizontal" id="temsellform" style="border-bottom: 1px solid gray;margin-bottom: 10px">

                                        <div class="form-group col-lg-4">
                                            <label class="control-label col-lg-3" style="text-align: left">Product</label>
                                            <div class="col-lg-8" style="padding-left: 0px">
                                                <?php
                                                $productlist = $this->db->query("select * from purchase group by product_name")->result();
                                                ?>
                                                <select class="form-control selectpicker" data-live-search="true" name="productid" id="productid" onchange="saveproduct(this.value)" required="" tabindex="1">
                                                    ...
                                                    if (sizeof($productlist) > 0):
                                                        foreach ($productlist as $allpro):
                                                            ?>
                                                            <option <?php echo ($allpro->product_id == $pid) ? 'selected' : '' ?> value="<?php echo $allpro->product_id; ?>"><?php echo $allpro->product_name . '-' . $allpro->pmodel . '-Purchase-Date: ' . $allpro->date; ?></option>
                                                            <?php
                                                        endforeach;
                                                    endif;
                                                    ?>                                                    
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" id="unitdata" readonly=""/>
                                            </div>
                                        </div>
                                    ...
                                    <form method="post" action="<?php echo site_url('issueproduct/saveissue'); ?>" class="form-horizontal" style="border-radius: 5px">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <div class="col-lg-8">                                                                                             
                                                ...
                                                <?php
                                                $getcustomer = $this->db->query("select id,ledgername from accountledger where accountgroupid = '30'")->result();
                                                ?>
                                                    ...
                                                    if (sizeof($selldata) > 0):
                                                        foreach ($selldata as $fsell):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo site_url('issueproduct/remove_issue/' . $fsell->id); ?>"><i class="fa fa-trash-o"></i></a></td>
                                                            </tr>
