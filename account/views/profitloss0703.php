                            ...
                            <table class="display table table-bordered" id="example1">
                                ...
                                <tr >
                                    ...
                                    <div class="row" style="text-align:left;">
                                        ...
                                        <div class="col-xs-6">Labour Cost= <?php echo number_format($labourcostquery->debit,2);$totaldebit+=$labourcostquery->debit;?></div>
                                        <div class="col-xs-6">Transport Cost = <?php echo number_format($transportcostquery->debit,2);$totaldebit+=$transportcostquery->debit;?></div>
                                    </div>
                                    <div class="row" style="text-align:left;">
                                        <div class="col-xs-6">Shipping Cost = <?php echo number_format($shippingcostquery->debit,2);$totaldebit+=$shippingcostquery->debit;?></div>
                                        <div class="col-xs-6">Other Cost = <?php echo number_format($othercostquery->debit,2);$totaldebit+=$othercostquery->debit;?></div>
                                       
                                    </div>

                                    <div class="row" style="text-align:left;">
                                        
                                        <div class="col-xs-6">Sales Discount = <?php echo number_format($discountquery->debit,2);$totaldebit+=$discountquery->debit;?></div>
                                        <div class="col-xs-6">Employee Salary = <?php echo number_format($employeequery->debit,2);$totaldebit+=$employeequery->debit;?></div>
                                    </div>

                                    <?php if(count($expenseledgerquery)>0) for ($i=0; $i <count($expenseledgerquery) ; $i+=2) { ?> 
                                        <div class="row" style="text-align:left;">
                                        
                                            <div class="col-xs-6"><?php echo $expenseledgerquery[$i]->ledgername.' = '.  number_format($expenseledgerquery[$i]->debit+$legderopeninarray[$expenseledgerquery[$i]->id],2);$totaldebit+=$expenseledgerquery[$i]->debit+$legderopeninarray[$expenseledgerquery[$i]->id];?></div>
                                            <?php if(array_key_exists($i+1, $expenseledgerquery)):?>
                                                <div class="col-xs-6"><?php echo $expenseledgerquery[$i+1]->ledgername.' = '.  number_format($expenseledgerquery[$i+1]->debit+$legderopeninarray[$expenseledgerquery[$i+1]->id],2);$totaldebit+=$expenseledgerquery[$i+1]->debit+$legderopeninarray[$expenseledgerquery[$i+1]->id];?></div>
                                            <?php endif;?>
                                        </div>
                                    ...
                                    <th style="border-left:3px solid;border-right:3px solid;text-align:center;white-space:nowrap" colspan="5">
                                        <div class="row" style="text-align:left;">
                                            ...
                                            <div class="col-xs-6">Purchase Discount = <?php echo number_format($discountquery->credit,2);$totalcredit+=$discountquery->credit;?></div>
                                        ...
                                        <div class="row" style="text-align:left;">
                                            ...
                                            <div class="col-xs-6"><?php echo $otherincomquery[$i]->ledgername.' = '.  number_format($otherincomquery[$i]->credit+($legderopeninarray[$otherincomquery[$i]->id]*-1),2);$totalcredit+=$otherincomquery[$i]->credit+($legderopeninarray[$otherincomquery[$i]->id]*-1);?></div>
                                            <?php if(array_key_exists($i+1, $otherincomquery)):?>
                                                <div class="col-xs-6"><?php echo $otherincomquery[$i+1]->ledgername.' = '.  number_format($otherincomquery[$i+1]->credit+($legderopeninarray[$otherincomquery[$i+1]->id]*-1),2);$totalcredit+=$otherincomquery[$i+1]->credit+($legderopeninarray[$otherincomquery[$i+1]->id]*-1);?></div>
                                            <?php endif;?>
                                        </div>
