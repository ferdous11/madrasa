            ...
            <div class="col-lg-12">                
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <div class="form">
                            <span style="float: right"><!-- <a href="#" data-toggle="modal" data-target="#addgroup"><button class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Account Group</button></a> --></span>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Update Account Group</h4>
                            </div>

                            <div class="modal-body">

                                <form class="form-horizontal" role="form"action="<?php echo site_url('master/updateacgroup'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="addgroup" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                        <h4 class="modal-title">Add New Account Group</h4>
                    </div>

                    <div class="modal-body">

                        <form class="form-horizontal" role="form"action="<?php echo site_url('master/addgroup'); ?>" method="post" enctype="multipart/form-data">
