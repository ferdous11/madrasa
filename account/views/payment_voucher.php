...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-8 col-sm-8">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" action="<?php echo site_url('payments/temp_payment'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form">
                                <br />
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control selectpicker" data-live-search="true" name="ledgerid" tabindex="1" onchange="getuserdetails(this.value)" required="">
                                ...
                                <div class="col-sm-3">
                                    <label for="amount">Payable Amount</label>
                                        <input style="height: 40px;font-size: 30px;" type="text" class="form-control"  value="" name="payamount" id="payamount" tabindex="5" readonly/>
                                    </div>
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <textarea class="form-control" name="description" tabindex="3" id="description"></textarea>
                                    </div>
                        ...
                        <table class="display table table-bordered table-striped dataTable">
                            <thead>
                                ...
                                <?php foreach ($uncomlitelist as $item) : ?>
                                    <tr>
                                        <td><a href="<?php echo site_url('payments/showtemp?randomkey=' . $item->invoiceid); ?>"><?php echo $item->invoiceid; ?></a></td>
                                        <td><?php echo $item->titem; ?></td>
                                        <td><?php echo $item->tprice; ?></td>
                                        <td><a href="<?php echo site_url('payments/tempremove?randomkey=' . $item->invoiceid); ?>"><i class="fa fa-trash-o" title="Remove purchase"></i></a></td>
                                    </tr>
                                <?php endforeach; ?>
            ...
            <form role="form" action="<?php echo site_url('payments/addpayments'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('payments/removedata?id=' . $item->id . '&randomkey=' . $randomkey); ?>"><i class="fa fa-trash-o" title="Remove purchase"></i></a></td>
                                    </tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold;text-align: right;"><?php echo moneyFormatIndia(ceil($total)) . " Tk."; ?></td>
                                <td colspan="2"></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label for="amount" class="col-lg-4 col-sm-4 control-label">Payment Date</label>
                        <div class="col-lg-7">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a style="" target="_blank" href="<?php echo site_url('reports/paymentshow/' . $payment->id); ?>"><i class="fa fa-print"></i></a>
                                </td>
                            </tr>
                    <?php
    ...
    function getuserdetails(ledgernameOrid) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#payamount").val(((Math.ceil(dataob.due))*-1).toLocaleString('en-IN'));}
