            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form" id="invoicediv">
                            <table style="font-family: adorsholipi;font-size: 18px;font-style: bold" border="0" class="display table">
                                ...
                                <tr>
                                  <td style="text-align: center;" colspan="3">
                                   ...
                                   <h2 style="margin: 5px;"><u>Purchase Return</u></h2>
                                  </td>
                                </tr>
                                <tr>
                                    <td>Ledger Name</td>
                            ...
                            <table style="font-family: adorsholipi;font-size: 18px;font-style: bold" border="0" class="display table">
                                ...
                                <tr>
                                    ...
                                    <td><b>Pr#<?php echo sprintf("%06d", $voicedata->id); ?></b></td>
                                </tr>
                            ...
                            <table border="1" class="display table table-bordered">
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $invoice->product_name;
                                                echo (($invoice->full_package == 1) ? "(Package)" : (($invoice->full_package == 2) ? "(Empty)" : (($invoice->full_package == 0) ? "(Refill)" : "")));
                                                echo $invoice->comment != "" ? "(" . $invoice->comment . ")" : ""; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <?php echo moneyFormatIndia(ceil($received)); ?>
                                    </td>
                                </tr>
                                ...
                                <!-- <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <?php echo moneyFormatIndia(ceil(0)); ?>
                                    </td>
                                </tr> -->
                        ...
                        &nbsp;<span style="float: right;margin-left: 15px"><a href="<?php if (isset($backtoreport) && $backtoreport) echo site_url('purchase/sellhistory');
                                                                                    else echo site_url('purchase/purchase_return') ?>"><button tabindex="3" class="btn btn-primary">Back</button></a></span>
                    </div>
                        ...
                        <div id="chalan">
                            <table style="font-family: adorsholipi;font-size: 18px;font-style: bold" border="0" class="display table">
                                ...
                                <tr>
                                  <td style="text-align: center;" colspan="3">
                                    <?php echo $company->address;?>
                                   <h2 style="margin: 5px;"><u>Purchase Return Chalan</u></h2>
                                  </td>
                                </tr>
                                <tr>
                                    <td>Ledger Name</td>
