    ...
    <section class="wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-sm-8">                
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <?php endif; ?>
                            <form class="form-horizontal" role="form"action="<?php echo site_url('purchase/purchasereturn_temp'); ?>" method="post" id="addform" enctype="multipart/form-data">
                                <div class="form">
                                <br/>
                                ...
                                <div class="form-group">
                                    <label for="productuniqid" class="col-lg-3 col-sm-4 control-label">Product Id</label>
                                ...
                                <div class="form-group">
                                    <label for="sellprice" class="col-lg-3 col-sm-4 control-label">Return Price</label>
                                    <div class="col-lg-3 col-sm-3">
                    ...
                    <div class="panel-body">
                        <table class="display table table-bordered table-striped dataTable">
                            <thead>
                                ...
                                <tr>
                                    <td><a href="<?php echo site_url('purchase/showtemp_return?randomkey=' .$item->randomkey ); ?>"><?php echo $item->randomkey;?></a></td>
                                    <td><?php echo $item->titem;?></td>
                                    <td><?php echo $item->tprice;?></td>
                                    <td><a href="<?php echo site_url('purchase/tempremove_return?randomkey=' .$item->randomkey ); ?>"><i class="fa fa-trash-o" title="Remove purchase"></i></a></td>
                                </tr>
                            <?php endforeach;?>
            ...
            <div class="col-lg-12 col-sm-12" style="margin-bottom: 60px">                
                <form class="form-horizontal" role="form"action="<?php echo site_url('purchase/purchase_return_submit'); ?>" method="post" enctype="multipart/form-data" onsubmit="stype.disabled = true; return true;" id="submitform">
                    <section class="panel">
                        <header class="panel-heading">
                                        ...
                                        if (sizeof($purchasedata) > 0):
                                            foreach ($purchasedata as $buy):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url('purchase/removedata_return?id=' . $buy->id . '&randomkey=' . $randomkey.'&sub_category='.$sub_category.'&category_id='.$category_id.'&date='.$date.'&suppliers='.$suppliers); ?>"><i class="fa fa-trash-o" title="Remove purchase"></i></a></td>
                                                </tr>
                                                <?php
                    ...
                    <div class="form">
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-lg-7 col-sm-6">
                                        ...
                                        ?>
                                                    ...
                                                    $supplier = $this->db->query("select l.*,d.name as district_name from accountledger as l left join districts as d on l.district=d.id where l.accountgroupid = 15 AND l.company_id = '$companyid' and l.status<>0 order by l.ledgername asc")->result();

                                                    if (sizeof($supplier) > 0 ):
                                                        foreach ($supplier as $suppr):
                                                            ?>
                                                            <option <?php echo ($suppr->id == $suppliers)? 'selected' : ''; ?> value="<?php echo $suppr->id; ?>"><?php echo $suppr->ledgername;                 echo $suppr->mobile!=null?" (" . $suppr->mobile.")":"";
                            ...
                            <div style="margin-top: 30px;" class="form-group">
                                <label for="ptotal" class="col-lg-3 col-sm-4 control-label">Received Amount</label>
                                <div class="col-lg-7 col-sm-6">
                                    <input tabindex="15" type="number" step="0.01" class="form-control" name="received_amount" value="" style=" height: 35px; font-size: 30px;"  />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-sm-6">  
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-sm-offset-3 col-lg-8 col-sm-8">  
                                    <input type="hidden" name="randomkey" value="<?php echo $randomkey; ?>"/>
                                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                    <button tabindex="14" type="submit" class="btn btn-primary" id="submitbutton" name="stype" value="onlysave">Confirm</button>
...
<script>
    ...
    function saveproduct(product_id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#pprice").val(jsonObject.purchase_price);
               
                if(jsonObject.category_id==6)
                    $("#sellprice").val(jsonObject.gas_price);
                else
                    $("#sellprice").val(jsonObject.purchase_price);
                $("#tprice").val(jsonObject.purchase_price)
    ...
    $('input[type="radio"]').click(function(){
            ...
            if($('input[name=RadioOptions]:checked').val()==0){
                ...
                $("#sellprice").val($("#empty_cylinder_price").val());
            }
