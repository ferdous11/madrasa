                            ...
                            <table style="font-family: adorsholipi;font-size: 18px;font-style: bold" border="0" class="display table">
                                    ...
                                    <tr>
                                        <td style="text-align: center;" colspan="3">
                                            ...
                                            <h2 style="margin: 5px;"><u>Payment Voucher</u></h2>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Ledger Name</td>
                                        <td>:</td>
                                        <td><?php echo '<b>' . $payments->ledgername . '</b>'; ?></td>
                                    </tr>
                                </table>
                                <table style="font-family: adorsholipi;font-size: 18px;font-style: bold" border="0" class="display table">
                                    <colgroup>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><small> <?php echo $payments->address;
                                                    echo $payments->district_name != "" ? ", " . $payments->district_name : ""; ?></small></td>
                                        <td><b>Pay#<?php echo sprintf("%06d", $payments->id); ?></b></td>
                                    </tr>

                                    <tr>
                                        <td><small>Mobile No</small></td>
                                        <td>:</td>
                                        <td><small><?php echo $payments->mobile; ?></small></td>
                                        <td><small><?php $date = strtotime($payments->date);
                                ...
                                <table border="1" class="display table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;vertical-align: middle;font-size:25px;height:1in;">
                                            <b><?php echo  moneyFormatIndia(ceil($payments->amount)) . " Tk."; ?></b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: middle;height:1in;">
                                            <p> <?php echo $payments->description; ?></p>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td colspan="2" style="text-align: center;height:1in;">
                                            <label style="float:left;margin-top:45px;">Authorized by: </label>
                                            <label style="float:right;margin-top:45px">Prepared by: <?php echo $payments->fullname; ?></label>
                                        </td>
                                    </tr>
                                </table>
                                <div class="row">
