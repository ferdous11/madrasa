            ...
            <div class="col-lg-12">
                <div class="panel">
                    <div class="panel-body">
                        <div class="clearfix">                
            				<form class="tasi-form" method="post" action="<?php echo site_url('reports/received'); ?>">
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <header class="panel-heading">
                            Receipt Voucher
                            <a href="<?php echo site_url('reports/export_received/'.$sdate.'/'.$edate); ?>"><button style="float: right; margin-left: 10px;" class="btn btn-primary "><i class="fa fa-file-o"> Export </i> </button></a> 
                        ...
                        <tbody id="invoicediv">
                            ...
                            if (sizeof($payments) > 0):
                                ...
                                <tr>
                                    ...
                                    <a target="_blank" style="margin-right: 50%" href="<?php echo site_url('received/edit/' . $payment->id) ?>" title="Edit Received"><i class="fa fa-edit"></i></a>  
                                      
                                    <a style="" href="<?php echo site_url('received/deletereceiptvoucher/' . $payment->id); ?>" onclick="return confirm('Are you sure want to delete this Voucher !!')"><i class="fa fa-trash-o"></i></a>
                                    <?php endif;?>
                                            
                                    </td> -->
                                    <td class="hidetoprint">
                                    <a style="" target="_blank" href="<?php echo site_url('reports/receivedshow/' . $payment->id); ?>" ><i class="fa fa-eye"></i></a>

                                    <?php 
                                    $prs = $this->db->query("select count(id) as rnumber from purchase_return_summary where invoiceid='$payment->invoiceid'")->row()->rnumber;
                                    $dss = $this->db->query("select count(id) as rnumber from daily_sell_summary where voucherid='$payment->invoiceid'")->row()->rnumber;
                                    $datef= date('Y-m-d'); if (($role=='admin'  ||  ($payment->date>$datef." 00:00:00" && $payment->date<$datef." 23:59:59"))&& !$prs&& !$dss):
                                    ?>

                                    <a style="margin-right: 50%" href="<?php echo site_url('received/edit/' . $payment->id) ?>" title="Edit Received"><i class="fa fa-edit"></i>
                                    </a>  
                                    <?php endif;?>
...
<script>
    ...
    function Clickheretoprint()
    {
        ...
        docprint.document.write('<html><title>Received Report</title>');
        ...
        docprint.document.write('</p><p style="margin:-10px 0 10px 0px;text-align:center;">Received History (' + from_date + ' to ' + to_date + ')</p>');
