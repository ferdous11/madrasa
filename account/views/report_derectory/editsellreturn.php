    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">Edit Sales Return ID: <?php echo "Sr-" . sprintf("%06d", $sellsummary->id); ?></div>
                        <div class="panel-body">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <!-- tempsell end -->
                                    <!-- sellproduct start -->
                                    <form method="post" action="<?php echo site_url('reports/updatesellreturnedit'); ?>" class="form-horizontal" style="border-radius: 5px">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <h5><b>Customer: <?php echo $supplierinfo->ledgername . "(" . $supplierinfo->address . "," .$supplierinfo->district_name . ")"; ?></b></h5>
                                            <!-- <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" step=".01" tabindex="12" name="discount" id="discount" value="<?php echo $sellsummary->discount; ?>" class="form-control t-r" onchange="finalcalculation()" />
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" step=".01" tabindex="12" name="payment" id="payment" value="<?php echo $sellsummary->payment; ?>" class="form-control t-r" onchange="finalcalculation()" />
                                                        <input type="hidden" name="ppayment" value="<?php echo $sellsummary->payment; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form class="form-horizontal" role="form" action="<?php echo site_url('reports/spsredit'); ?>" method="post" enctype="multipart/form-data">
