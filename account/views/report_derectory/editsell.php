    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">Edit Sales Invoice ID: <?php echo "Inv-" . sprintf("%06d", $sellsummary->id); ?></div>
                        <div class="panel-body">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <!-- tempsell end -->
                                    <!-- sellproduct start -->
                                    <form method="post" action="<?php echo site_url('reports/updateedit'); ?>" class="form-horizontal" style="border-radius: 5px">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th class="t-r" style="background: greenyellow"><?php echo(round($demototal,0,PHP_ROUND_HALF_UP)); ?>
                                                            <input type="hidden" id="totalprice" name="totalprice" value="<?php echo(round($demototal,0,PHP_ROUND_HALF_UP)) ?>" />
                                                        </th>
                                                        <th></th>
                                                    </tr>
                                                </tfoot>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" tabindex="12" name="sumComment" value="<?php echo $sellsummary->comment; ?>" class="form-control" />
                                                    </div>
                                                </div>
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    <label class="control-label col-lg-5">Discount</label>
                                                    <div class="col-lg-6">
                                                        <input type="number" step="1" required tabindex="12" name="discount" id="discount" value="<?php echo (int)$sellsummary->discount; ?>" class="form-control t-r" onchange="finalcalculation()" />
                                                        <input type="hidden" name="pdiscount" value="<?php echo (int)$sellsummary->discount; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input style="background-color: greenyellow" type="number" step="1" name="totaldue" id="totaldue" value="<?php echo (int)$sellsummary->total_price - $sellsummary->discount; ?>" class="form-control t-r" readonly="" />
                                                        <input type="hidden" name="ptotaldue" value="<?php echo (int)$sellsummary->total_price - $sellsummary->discount; ?>">
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6"><b>
                                                            <input tabindex="15" style="font-family: AdorshoLipi;font-size: 22px;" required type="number" step="1" name="paidAmount" id="paidAmount" value="<?php echo (int)$sellsummary->paid_amount; ?>" class="form-control t-r" onchange="finalcalculation()" /></b>
                                                        <input type="hidden" name="ppaidAmount" value="<?php echo (int)$sellsummary->paid_amount; ?>">
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input style="background-color: greenyellow" type="text" name="preDue" id="preDue" value="<?php echo (int) $sellsummary->pre_due; ?>" class="form-control t-r" readonly="" />
                                                        <input type="hidden" name="ppreDue" value="<?php echo (int)$sellsummary->pre_due; ?>">
                                                ...
                                                <div class="panel-heading col-lg-offset-2 col-lg-10" style="background: #f1f2f7;color: #000;">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input style="background-color: greenyellow" type="text" name="fTotalDue" id="fTotalDue" value="<?php echo (int) $sellsummary->due; ?>" class="form-control t-r" readonly="" />
                                                        <input type="hidden" name="pfTotalDue" value="<?php echo (int)$sellsummary->due; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form class="form-horizontal" role="form" action="<?php echo site_url('reports/spedit'); ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-3 col-sm-3">
                                                                        <input type="text" class="form-control t-r" name="sellprice" id="sellprice" value="<?php echo ($selld->sellprice); ?>" required="">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-lg-offset-4 col-lg-8 col-sm-offset-4 col-sm-8">
                                                                        ...
                                                                        <input type="hidden" name="pprice" value="<?php echo $selld->sellprice; ?>" />
...
<script type="text/javascript" charset="utf-8">
    ...
    function finalcalculation() {
        var demototal = <?php echo round($demototal,0,PHP_ROUND_HALF_UP); ?>;
        //var vat =  ($("#vat").val());
        ...
        $("#fTotalDue").val((parseFloat(demototal) - parseFloat(discount) + parseFloat(preDue) - parseFloat(paidAmount)).toString());
        $("#gamount").val((parseFloat(ramount) - parseFloat(paidAmount)).toString());
    ...
    function getuserdetails(ledgernameOrid) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url("reports/getcustomerdetails") ?>',
            data: datastring,
            success: function(response) {
